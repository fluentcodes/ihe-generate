...
public class IheHelperSlots {
    public static SlotType1 createSlot(final String name, final String... values) {
        return createSlot(name, Arrays.asList(values));
    }

    public static SlotType1 createSlot(final String name, Collection<String> values) {
        SlotType1 slot = IheHelper.OF_RIM.createSlotType1();
        if (values == null) {
            return slot;
        }

        slot.setName(name);
        ValueListType valueList =  IheHelper.OF_RIM.createValueListType();
